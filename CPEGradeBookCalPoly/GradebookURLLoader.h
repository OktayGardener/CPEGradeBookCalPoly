 ...
 */
@property (nonatomic, copy, nonnull) NSURL *baseURL;
 ...
 */
- (BOOL) loginWithUsername: (nonnull NSString*) username andPassword: (nonnull NSString*) password;
 ...
 */
- (nullable NSData*) loadDataFromPath: (nonnull NSString*) urlSuffix error: (NSError * _Nullable * _Nullable) err;
 ...
 */
- (nonnull NSMutableURLRequest*) requestForPath: (nonnull NSString*)urlSuffix
                        withRequestDict: (nullable NSDictionary*) reqDict;
